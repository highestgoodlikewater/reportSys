...
<!-- END STYLE SWITCHER -->
    ...
    <script src="/myDemo/reportSys/Public/Home/echarts/doc/asset/js/esl/esl.js"></script>
    <!--<script src="../assets/js/zidingyi/iframe-height.js" type="text/javascript" language="javascript" ></script>-->
    <script src="/myDemo/reportSys/Public/Home/echarts/build/dist/echarts.js"></script>
   <script type="text/javascript">  
       require.config({   // 路径配置  
            paths: {
                echarts: '/myDemo/reportSys/Public/Home/echarts/build/dist'
            }
        });
        // 使用
        require(
